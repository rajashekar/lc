...
mod alias_delete_tests {
    ...
    fn create_config_with_aliases() -> Config {
        ...
        config
            .aliases
            .insert("gpt35".to_string(), "openai:gpt-3.5-turbo".to_string());
    ...
    fn test_alias_delete_empty_name() {
        ...
        config
            .aliases
            .insert("".to_string(), "openai:gpt-4".to_string());
...
mod alias_list_tests {
    ...
    fn test_alias_list_immutable() {
        ...
        config
            .aliases
            .insert("test".to_string(), "provider:model".to_string());
...
mod alias_resolution_tests {
    ...
    fn test_alias_resolution_chain() {
        ...
        config
            .aliases
            .insert("best".to_string(), "gpt4".to_string());
...
mod alias_integration_tests {
    ...
    fn test_alias_persistence_simulation() {
        ...
        // Add aliases
        config1
            .add_alias("gpt4".to_string(), "openai:gpt-4".to_string())
            .unwrap();
        config1
            .add_alias("fast".to_string(), "openai:gpt-3.5-turbo".to_string())
            .unwrap();
