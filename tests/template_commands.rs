...
mod template_add_tests {
    ...
    fn test_template_add_multiple() {
        ...
        let result1 = config.add_template(
            "code_review".to_string(),
            "You are a senior software engineer reviewing code.".to_string(),
        );
        let result2 = config.add_template(
            "documentation".to_string(),
            "You are a technical writer creating clear documentation.".to_string(),
        );
        let result3 = config.add_template(
            "debugging".to_string(),
            "You are an expert debugger helping to solve issues.".to_string(),
        );
        ...
        assert_eq!(
            config.get_template("code_review"),
            Some(&"You are a senior software engineer reviewing code.".to_string())
        );
        assert_eq!(
            config.get_template("documentation"),
            Some(&"You are a technical writer creating clear documentation.".to_string())
        );
        assert_eq!(
            config.get_template("debugging"),
            Some(&"You are an expert debugger helping to solve issues.".to_string())
        );
    ...
    fn test_template_add_overwrite_existing() {
        ...
        let result1 =
            config.add_template("prompt".to_string(), "Original prompt content".to_string());
        assert!(result1.is_ok());
        assert_eq!(
            config.get_template("prompt"),
            Some(&"Original prompt content".to_string())
        );

        // Overwrite with new content
        let result2 =
            config.add_template("prompt".to_string(), "Updated prompt content".to_string());
        assert!(result2.is_ok());
        assert_eq!(
            config.get_template("prompt"),
            Some(&"Updated prompt content".to_string())
        );
    ...
    fn test_template_add_empty_name() {
        ...
        assert_eq!(
            config.get_template(""),
            Some(&"Some prompt content".to_string())
        );
    }
    ...
    fn test_template_add_special_characters() {
        ...
        let result1 =
            config.add_template("code-review".to_string(), "Code review prompt".to_string());
        let result2 = config.add_template(
            "code_review".to_string(),
            "Code review with underscore".to_string(),
        );
        let result3 = config.add_template(
            "code.review".to_string(),
            "Code review with dot".to_string(),
        );
        let result4 = config.add_template(
            "code123".to_string(),
            "Code review with numbers".to_string(),
        );
        ...
        // Verify all templates exist
        assert_eq!(
            config.get_template("code-review"),
            Some(&"Code review prompt".to_string())
        );
        assert_eq!(
            config.get_template("code_review"),
            Some(&"Code review with underscore".to_string())
        );
        assert_eq!(
            config.get_template("code.review"),
            Some(&"Code review with dot".to_string())
        );
        assert_eq!(
            config.get_template("code123"),
            Some(&"Code review with numbers".to_string())
        );
    }
    ...
    fn test_template_add_multiline_content() {
        ...
        assert_eq!(
            ...
            Some(&multiline_prompt.to_string())
        );
    }
...
mod template_delete_tests {
    ...
    fn test_template_delete_empty_name() {
        ...
        config
            .templates
            .insert("".to_string(), "Empty name template".to_string());
...
mod template_list_tests {
    ...
    fn test_template_list_with_templates() {
        ...
        assert_eq!(
            templates.get("code_review"),
            Some(&"You are a senior software engineer reviewing code.".to_string())
        );
        assert_eq!(
            templates.get("documentation"),
            Some(&"You are a technical writer creating clear documentation.".to_string())
        );
        assert_eq!(
            templates.get("debugging"),
            Some(&"You are an expert debugger helping to solve issues.".to_string())
        );
    }
    ...
    fn test_template_list_ordering() {
        ...
        config
            .templates
            .insert("zebra".to_string(), "Zebra template".to_string());
        config
            .templates
            .insert("alpha".to_string(), "Alpha template".to_string());
        config
            .templates
            .insert("beta".to_string(), "Beta template".to_string());
    ...
    fn test_template_list_immutable() {
        ...
        config
            .templates
            .insert("test".to_string(), "Test template".to_string());
...
mod template_resolution_tests {
    ...
    fn create_config_with_templates() -> Config {
        ...
        config
            .templates
            .insert("short".to_string(), "Brief".to_string());
    ...
    fn test_template_resolve_with_prefix() {
        ...
        assert_eq!(
            config.resolve_template_or_prompt("t:code_review"),
            "You are a senior software engineer reviewing code."
        );
        assert_eq!(
            config.resolve_template_or_prompt("t:documentation"),
    ...
    fn test_template_resolve_nonexistent() {
        ...
        assert_eq!(
            config.resolve_template_or_prompt("t:nonexistent"),
            "t:nonexistent"
        );
    ...
    fn test_template_resolve_without_prefix() {
        ...
        assert_eq!(
            config.resolve_template_or_prompt("code_review"),
            "code_review"
        );
        assert_eq!(
            config.resolve_template_or_prompt("regular prompt"),
            "regular prompt"
        );
    ...
    fn test_template_resolve_edge_cases() {
        ...
        assert_eq!(
            config.resolve_template_or_prompt("tt:code_review"),
            "tt:code_review"
        ); // Wrong prefix
        assert_eq!(
            config.resolve_template_or_prompt("t::code_review"),
        ...
        assert_eq!(
            config.resolve_template_or_prompt("prefix t:code_review"),
            "prefix t:code_review"
        ); // Not at start
    }
    ...
    fn test_template_resolve_special_characters() {
        ...
        config.templates.insert(
            ...
            "Template with special characters: !@#$%^&*()".to_string(),
        );
        config.templates.insert(
            "unicode".to_string(),
            "Template with unicode: 🚀 ✨ 🎉".to_string(),
        );
        config.templates.insert(
            "quotes".to_string(),
            "Template with \"quotes\" and 'apostrophes'".to_string(),
        );

        // Test resolving templates with special content
        assert_eq!(
            config.resolve_template_or_prompt("t:special-chars"),
            "Template with special characters: !@#$%^&*()"
        );
        assert_eq!(
            config.resolve_template_or_prompt("t:unicode"),
            "Template with unicode: 🚀 ✨ 🎉"
        );
        assert_eq!(
            config.resolve_template_or_prompt("t:quotes"),
...
mod template_validation_tests {
    ...
    fn test_template_content_validation() {
        ...
        for (i, content) in test_contents.iter().enumerate() {
            ...
            assert!(
                result.is_ok(),
                "Failed to add template with content: {}",
                content
            );
    ...
    fn test_template_name_uniqueness() {
        ...
        // Add template
        config
            .add_template("unique".to_string(), "First content".to_string())
            .unwrap();
        assert_eq!(
            config.get_template("unique"),
            Some(&"First content".to_string())
        );

        // Add template with same name - should overwrite
        config
            .add_template("unique".to_string(), "Second content".to_string())
            .unwrap();
        assert_eq!(
            config.get_template("unique"),
            Some(&"Second content".to_string())
        );
...
mod template_integration_tests {
    ...
    fn test_template_workflow_complete() {
        ...
        let result = config.add_template(
            "code_review".to_string(),
            "You are an expert code reviewer with 10+ years experience.".to_string(),
        );
        assert!(result.is_ok());
        assert_eq!(config.list_templates().len(), 2); // Still 2 templates
        assert_eq!(
            config.get_template("code_review"),
            Some(&"You are an expert code reviewer with 10+ years experience.".to_string())
        );
    ...
    fn test_template_persistence_simulation() {
        ...
        assert_eq!(
            config2.get_template("code_review"),
            Some(&"You are a senior software engineer reviewing code.".to_string())
        );
        assert_eq!(
            config2.get_template("documentation"),
            Some(&"You are a technical writer creating clear documentation.".to_string())
        );

        // Test resolution still works
        assert_eq!(
            config2.resolve_template_or_prompt("t:code_review"),
            "You are a senior software engineer reviewing code."
        );
    }
    ...
    fn test_template_complex_scenarios() {
        ...
        config
            .add_template("simple".to_string(), "Simple template".to_string())
            .unwrap();
        config
            .add_template(
                "multiline".to_string(),
        ...
        config
            .add_template(
                "with_template_ref".to_string(),
                "This contains t:simple reference".to_string(),
            )
            .unwrap();
        config
            .add_template(
        ...
        assert_eq!(
            config.resolve_template_or_prompt("t:simple"),
            "Simple template"
        );
        assert_eq!(
            config.resolve_template_or_prompt("t:multiline"),
            "Line 1\nLine 2\nLine 3"
        );
        assert_eq!(
            config.resolve_template_or_prompt("t:with_template_ref"),
            "This contains t:simple reference"
        ); // No recursive resolution
        assert_eq!(
            config.resolve_template_or_prompt("t:json"),
            "{\"role\": \"assistant\", \"content\": \"Hello\"}"
        );

        // Test non-template inputs
        assert_eq!(
            config.resolve_template_or_prompt("regular input"),
            "regular input"
        );
        assert_eq!(
            config.resolve_template_or_prompt("t:nonexistent"),
